...
def save_files(js_data, images, do_make_zip, index):
    ...
    # quick dictionary to class object conversion. Its necessary due
    # apply_filename_pattern requiring it
    class MyObject:
...
def create_refresh_button(refresh_component, refresh_method, refreshed_args, elem_id):
    ...
    refresh_button = ToolButton(
        value=refresh_symbol, elem_id=elem_id, tooltip=f"{label}: refresh" if label else "Refresh"
    )
